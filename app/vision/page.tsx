...
export const metadata: Metadata = {
  title: "Vision | Cynical Technology",
  description:
    "Corporate Vision at Cynical Technology. Redefining trust and resilience in the digital age through uncompromising security and intelligent innovation.",
};
