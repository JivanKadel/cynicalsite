...
export default function VisionPage() {
  return (
    <>
      <Head>
        <title>Vision | Cynical Technology</title>
        <meta
          name="description"
          content="Corporate Vision at Cynical Technology. Redefining trust and resilience in the digital age through uncompromising security and intelligent innovation."
        />
      </Head>
        ...
        <section className="py-12">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Integrated solutions designed to transform security from barrier
              to enabler
            </p>
          </div>
