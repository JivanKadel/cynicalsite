...
const Contact = () => {
  ...
  return (
    <>
      <Head>
        <title>Contact | Cynical Technology</title>
        <meta
          name="description"
          content="Get in touch with Cynical Technology for your cybersecurity needs. We're here to help you secure your digital assets."
        />
      </Head>
