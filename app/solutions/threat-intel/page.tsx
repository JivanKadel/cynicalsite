...
const ThreatIntelligence = () => {
  ...
  return (
    <>
      <Head>
        <title>Threat Intelligence | Cynical Technology</title>
        <meta
          name="description"
          content="Threat Intelligence at Cynical Technology. Stay ahead of emerging threats with real-time actionable intelligence."
        />
      </Head>
      <div>
        ...
        <section className="py-20 lg:py-32 bg-secondary/20">
          <div className="container mx-auto px-6">
            <div className="text-center max-w-4xl mx-auto mb-16">
              ...
              <p className="text-lg text-muted-foreground font-body leading-relaxed">
                Three levels of intelligence tailored to different
                organizational needs and security maturity levels.
              </p>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-start">
              <div className="lg:sticky lg:top-32">
                ...
                <p className="text-lg text-muted-foreground font-body leading-relaxed mb-8">
                  Our intelligence cycle combines automated collection with
                  expert analysis using STIX/TAXII frameworks, MITRE ATT&CK
                  mapping, and proprietary threat scoring algorithms.
                </p>
              </div>
          ...
          <div className="container mx-auto px-6">
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-16">
                ...
                <p className="text-lg text-muted-foreground font-body leading-relaxed">
                  Our intelligence covers the full spectrum of cyber threats
                  from nation-state actors to cybercriminal organizations and
