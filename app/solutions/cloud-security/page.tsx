...
const CloudSecurity = () => {
  ...
  return (
    <>
      <Head>
        <title>Cloud Security | Cynical Technology</title>
        <meta
          name="description"
          content="Cloud Security at Cynical Technology. Protecting your cloud infrastructure with expert assessments and continuous monitoring."
        />
      </Head>
      <div>
          ...
          <div className="container mx-auto px-6 relative">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-lg md:text-xl text-muted-foreground font-body max-w-2xl mx-auto mb-4 leading-relaxed">
                Comprehensive cloud security assessments and continuous
                monitoring for AWS, Azure, and GCP. Our certified cloud security
                specialists identify misconfigurations and vulnerabilities that
