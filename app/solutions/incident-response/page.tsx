...
const IncidentResponse = () => {
  ...
  return (
    <>
      <Head>
        <title>Incident Response | Cynical Technology</title>
        <meta
          name="description"
          content="Incident Response at Cynical Technology. Rapid response, forensic analysis, and recovery services for cyber incidents."
        />
      </Head>
      <div>
          ...
          <div className="container mx-auto px-6">
            <div className="text-center max-w-4xl mx-auto mb-16">
              ...
              <p className="text-lg text-muted-foreground font-body leading-relaxed">
                ...
                from initial detection through full recovery and lessons
                learned.
              </p>
            </div>
