...
export default function ApplicationSecurity() {
  ...
  return (
    <>
      <Head>
        <title>App Security | Cynical Technology</title>
        <meta
          name="description"
          content="Application Security at Cynical Technology. Making your applications safer and more resilient against threats."
        />
      </Head>
      <div>
