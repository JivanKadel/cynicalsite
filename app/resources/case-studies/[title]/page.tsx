...
const GlobalInvestmentBank = () => {
  return (
    <>
      <Head>
        <title>Case Studies | Cynical Technology</title>
        <meta
          name="description"
          content="Case Studies at Cynical Technology. Our team closes vulnerabilities to make the digital ecosystem safer for everyone."
        />
      </Head>
      <div>
                ...
                <div className="lg:col-span-8 space-y-4 sm:space-y-8">
                  ...
                  <div className="grid sm:grid-cols-2 gap-4">
                    {[
                      ...
                      {
                        icon: Clock,
                        text: "SOC 2 Type II deadline in 6 weeks",
                      },
                      {
                        icon: Shield,
