...
export const metadata: Metadata = {
  title: "Case Studies | Cynical Technology",
  description:
    "Case Studies at Cynical Technology. Our team closes vulnerabilities to make the digital ecosystem safer for everyone.",
};
