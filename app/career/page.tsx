...
const Careers = () => {
  ...
  return (
    <>
      <Head>
        <title>Career | Cynical Careers</title>
        <meta
          name="description"
          content="Explore exciting career opportunities at Cynical. Join our team of cybersecurity experts."
        />
      </Head>
      <div>
        {/* Hero Section */}
        ...
        <section className="py-20 lg:py-32">
          <div className="container mx-auto px-6">
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <p className="text-lg text-muted-foreground font-body leading-relaxed">
                Transparent and efficient hiring process designed to find the
                best talent while respecting your time.
              </p>
            </div>
                ...
                <Card className="border-border bg-background">
                  <CardContent className="p-12">
                    ...
                    <p className="text-muted-foreground font-body mb-8">
                      ...
                      always interested in connecting with talented
                      cybersecurity professionals. Submit your CV and we&apos;ll
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <Card className="border-border bg-background">
                <CardContent className="p-6">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Regular tech talks, workshops, and knowledge sharing
                    sessions
                  </p>
                </CardContent>
              </Card>
