...
const SampleReportPage = () => {
  return (
    <main className="pb-16 py-8 md:py-16 flex flex-col justify-center">
      <div className="container mx-auto px-2 sm:px-6">
        <div className="max-w-7xl mx-auto">
          <div className="mx-auto flex items-center lg:flex-row lg:justify-center flex-col gap-12  lg:gap-8">
                ...
                <div>
                  ...
                  <div className="space-y-10">
                    <div className="flex items-start group">
                      <div className="flex-shrink-0 w-12 h-12 bg-white border border-slate-200 rounded-lg flex items-center justify-center text-slate-900 mr-6 shadow-sm group-hover:border-slate-400 transition-colors">
                        <svg
                      ...
                      <div>
                        ...
                        <p className="text-slate-600 leading-relaxed text-[15px]">
                          Prioritized vulnerabilities across IT assets with
                          severity scoring and business impact analysis.
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start group">
                    ...
                    <div className="flex items-start group">
                      ...
                      <div>
                        ...
                        <p className="text-slate-600 leading-relaxed text-[15px]">
                          Insights aligned with ISO 27001, PCI DSS, HIPAA, and
                          other global regulatory standards.
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start group">
                      <div className="flex-shrink-0 w-12 h-12 bg-background border border-slate-200 dark:border-slate-600 rounded-lg flex items-center justify-center text-slate-900 dark:text-slate-300 mr-6 shadow-sm group-hover:border-slate-400 transition-colors">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width="22"
                          height="22"
                      ...
                      <div>
                        ...
                        <p className="text-slate-600 leading-relaxed text-[15px]">
                          No generic automated scans—findings tailored
                          specifically to real-world environments.
                        </p>
                      </div>
                    </div>
                  </div>
            ...
            <div className="bg-white border border-slate-200 rounded-xl shadow-[0_8px_24px_rgba(0,0,0,0.06)] p-8 sticky top-8 min-w-85 max-w-[450px] w-full">
              <div className="mb-8">
              ...
              <div className="mt-8 pt-6 border-t border-slate-100 grid grid-cols-1 gap-3">
                <div className="flex items-center justify-center lg:justify-start text-xs font-medium text-slate-500 bg-slate-50 py-2 px-3 rounded">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                    height="24"
                    ...
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    className="lucide lucide-lock w-3 h-3 mr-2 text-slate-400"
                    aria-hidden="true"
                  >
                    <rect
                      width="18"
          ...
          <div className="mt-16 border-t border-slate-200 bg-slate-50 py-20">
            <div className="max-w-[1200px] mx-auto px-6 text-center">
              ...
              <Link href={"/contact"}>
                <button className="bg-white border border-slate-300 hover:border-slate-900 text-slate-900 font-bold px-8 py-3.5 rounded-lg transition-all flex items-center mx-auto shadow-sm hover:shadow-md">
