...
//   return (
//     <div className="relative col-span-3 xl:ml-8 lg:mt-8 lg:mt-0 scale-120 transform-[translateY(25%)_translateX(30%)_scale(1.7)_rotateX(30deg)_rotateY(20deg)_rotate(345deg)]">
//       <Image
