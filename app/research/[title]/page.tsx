...
export default function ResearchDetailPage() {
  return (
    <>
      <Head>
        <title>Research | Cynical Technology</title>
        <meta
          name="description"
          content="Discover Security Research at Cynical Technology. Our team continuously discovers and responsibly discloses vulnerabilities to make the digital ecosystem safer for everyone."
        />
      </Head>
      <div>
          ...
          <div className="container mx-auto px-6">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-lg md:text-xl text-muted-foreground font-body max-w-2xl mx-auto mb-12 leading-relaxed">
                A comprehensive analysis of critical SQL injection
                vulnerabilities discovered in widely-deployed enterprise ERP
                systems, affecting over 2,500 organizations globally.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="max-w-5xl mx-auto">
              <div className="grid grid-cols-1 sm:grid-cols-4 gap-8 text-center">
                {[
                  ...
                  <div key={stat.label}>
                    <h2 className="text-xl text-foreground md:text-2xl font-bold mb-1">
                      {stat.value}
                    </h2>
            ...
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-20">
                ...
                <p className="text-base md:text-lg leading-relaxed text-foreground/70">
                  ...
                  discovered a series of critical SQL injection vulnerabilities
                  in three major enterprise ERP platforms. These vulnerabilities
...
SELECT * FROM users WHERE username = 'admin'--' AND password = ''`}</code>
                ...
                <div className="text-center mb-20">
                  <p className="text-base md:text-lg leading-relaxed text-foreground/70">
                    The vulnerable endpoint is exposed on the public-facing
                    login page, requiring no prior authentication. Successful
