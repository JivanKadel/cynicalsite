...
export default function EventsPage() {
  return (
    <>
      <Head>
        <title>Events | Cynical Technology</title>
        <meta
          name="description"
          content="Join workshops, hackathons, and conferences led by top security researchers. Sharpen your skills in real-time."
        />
      </Head>
      <div>
