...
export const metadata: Metadata = {
  title: "Event Details | Cynical Technology",
  description:
    "Join our events to enhance your cybersecurity skills. Learn from experts, gain hands-on experience, and explore new career opportunities.",
};
