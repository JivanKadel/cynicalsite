...
export default function EventDetailsPage() {
  ...
  return (
    <>
      <Head>
        <title>Event Details | Cynical Technology</title>
        <meta
          name="description"
          content="Join our events to enhance your cybersecurity skills. Learn from experts, gain hands-on experience, and explore new career opportunities."
        />
      </Head>
      <div>
