...
export default function PricingPage() {
  return (
    <>
      <Head>
        <title>Pricing | Cynical Technology</title>
        <meta
          name="description"
          content="Explore the pricing plans for Cynical Technology's security solutions. Find the right plan for your business needs."
        />
      </Head>
        ...
        >
          ...
          <section className="p-2">
            ...
            <p className="font-sans text-base text-foreground/70 font-normal lg:text-lg mt-4">
              ...
              From agile startups to global enterprises. With full access, you
              can strengthen and safeguard your web applications continuously,
              without compromise.
            </p>
