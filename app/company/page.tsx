...
export default function AboutUs() {
  ...
  return (
    <>
      <Head>
        <title>About | Cynical Technology</title>
        <meta
          name="description"
          content="Learn more about Cynical Technology, our mission, team, and values in cybersecurity."
        />
      </Head>
      <div>
        {/* Hero Section */}
              ...
              <div className="space-y-8">
                <div className="space-y-4">
                  ...
                  <p className="text-lg text-muted-foreground font-body leading-relaxed">
                    Founded in 2018, Cynical has rapidly become a trusted
                    partner for organizations worldwide seeking enterprise-grade
        ...
        <section className="py-20 lg:py-32">
          <div className="container mx-auto px-6">
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <p className="text-lg text-muted-foreground font-body leading-relaxed">
                Industry recognition for our excellence in cybersecurity
        ...
        {/* Team Section */}
        <section
          className="py-20 lg:py-32 mx-auto bg-secondary/20"
          id="our-team"
        >
          <div className="container mx-auto px-6">
            <div className="text-center max-w-3xl mx-auto mb-16">
