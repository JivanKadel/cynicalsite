...
export const metadata: Metadata = {
  title: "Research | Cynical Technology",
  description:
    "Discover Security Research at Cynical Technology. Our team continuously discovers and responsibly discloses vulnerabilities to make the digital ecosystem safer for everyone.",
};
